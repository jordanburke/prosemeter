...
[main README](https://github.com/jordanburke/prosemeter#readme) for the full
picture: the agent loop, profiles, the CLI, and the MCP server.

## Install

```bash
pnpm add @prosemeter/style
```
