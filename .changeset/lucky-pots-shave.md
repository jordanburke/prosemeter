...
"@prosemeter/mcp": minor
"prosemeter": minor
---

Rename four dimensions so every dimension is virtue-named, and fix the hedging false-positive rate.
...
`retext-repeated-words`, and `retext-redundant-acronyms` all keep their names, because rules *are*
